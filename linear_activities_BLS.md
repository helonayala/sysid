...
1. Improve the baseline code (using the simulated dataset)
   ...
   * *Tip:* Consider a function like `matReg` in [narendra.ipynb](https://github.com/helonayala/narx_narendra/blob/main/narendra.ipynb).
   ...
   * *Tip:* Consider a function like `freeRun` in [narendra.ipynb](https://github.com/helonayala/narx_narendra/blob/main/narendra.ipynb).
...
2. Apply to Real-World Data:
   ...
   **a.** Substitute the synthetic data generated in the notebook with the dataset you'll use for your project. You may choose an example from the case studies section too. Ask the instructor if unsure.
